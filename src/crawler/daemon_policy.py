...
class DaemonSchedulerPolicy:
    ...
    def prepare_scheduler(
        self, scheduler: Scheduler, *, refresh_stale: Callable[[], None] | None = None
    ) -> dict[str, int]:
    ...
    def prime_scheduler(self, scheduler: Scheduler) -> dict[str, int]:
    ...
    def admit_discovered(self, scheduler: Scheduler) -> int:
    ...
    def ensure_runnable_supply(self, scheduler: Scheduler) -> None:
    ...
    def promote_blocked_retry(self, scheduler: Scheduler) -> int:
    ...
    def retire_blocked_retry(self, scheduler: Scheduler) -> int:
    ...
    def restore_recovered_blocked_retry(self, scheduler: Scheduler) -> int:
    ...
    def _retry_quarantine_count(self, scheduler: Scheduler) -> int:
        return int(scheduler.blocked_host_backoff_count() or 0)

    def _rebalance_blocked(self, scheduler: Scheduler) -> int:
        quarantined, _restored = scheduler.rebalance_blocked_host_backoff()
        return quarantined

    def _runnable_supply_hosts(self, scheduler: Scheduler) -> int:
        return scheduler.runnable_host_count(runnable_surface=SCHEDULER_SURFACE_RUNNABLE)

    def _runnable_supply_count(self, scheduler: Scheduler) -> int:
